...
geodata = geodata.to_crs(CRS.from_epsg(32634))
...
import requests
import geojson
url = 'https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-mesh500h30.html#prefecture1'
params = dict(service='WFS',version='2.0.0',request='GetFeature',typeName='asuminen_ja_maankaytto:Vaestotietoruudukko_2018',outputFormat='json')
